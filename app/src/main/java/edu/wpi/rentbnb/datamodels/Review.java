 ...
 * This table contains a list of review submitted by the users regarding the rental spaces that have been
 previously visited/rented.
 */
...
public class Review {
    ...
    /**
     * Indicates the creation date of the review comment for the apartment listing
     */

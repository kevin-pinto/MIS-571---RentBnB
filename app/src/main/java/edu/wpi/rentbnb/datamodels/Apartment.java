 ...
 * This class contains a higher level detailed information regarding the locality, total number of
   rooms in the apartment and the tags associated with the apartment.
 */

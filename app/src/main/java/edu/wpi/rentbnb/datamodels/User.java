 ...
 * This class consists a list of all the details pertaining to the user. Here, the user_type attribute defines the
 type of the student/user who could either be a Tenant or a Leaser. These details are captured while
 registering a user on the application for the first time.
 */

...
public class RentalSpace implements Serializable {
	...
	private Integer id;
	/**
	 * Indicates the apartment id that has been provided for the given rental
	 * space
	 */
	...
	/**
	 * Indicates the description that has been provided for the given rental
	 * space
	 */
	private String description;
	/**
	 * Indicates the availability from that has been provided for the given
	 * rental space
	 */
	private Date availableFrom;
	/**
	 * Indicates the availability to that has been provided for the given rental
	 * space
	 */
	...
	public String toString() {
		return "RentalSpace{" + "id=" + id + ", aptId=" + aptId + ", landlordId=" + landlordId + ", price=" + price + ", description='" + description + '\'' + ", availableFrom=" + availableFrom
				+ ", availableTo=" + availableTo + ", creationDate=" + creationDate + ", isRented=" + isRented + ", isVerified=" + isVerified + ", isUtilitiesIncluded=" + isUtilitiesIncluded + '}';
	}
}
